...
function Somali({ jobs }){
    ...
    const SomaliJobs = jobs.filter((job) => job.country === "Somalia")

    const renderedJobs = SomaliJobs.map((job) => (
    ...
    return(
        <div>
            <h1 className="text-center text-decoration-underline">SOMALIA</h1>
