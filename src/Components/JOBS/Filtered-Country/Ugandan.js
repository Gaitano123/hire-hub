...
function Ugandan({ jobs }){
    ...
    const UgandanJobs = jobs.filter((job) => job.country === "Uganda")

    const renderedJobs = UgandanJobs.map((job) => (
    ...
    return(
        <div>
            <h1 className="text-center text-decoration-underline">UGANDA</h1>
