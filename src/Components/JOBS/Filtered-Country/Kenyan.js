...
function Kenyan({ jobs }){
    ...
    const KenyanJobs = jobs.filter((job) => job.country === "Kenya")

    const renderedJobs = KenyanJobs.map((job) => (
    ...
    return(
        <div>
            <h1 className="text-center text-decoration-underline">KENYA</h1>
